...
const Restaurants = () => {
    ...
    const redirectToDinner = () => {
        navigate('/dinnerrestaurants', { state: { myLocation, placesAttractions: placesAttractions, selectedDate} });
    }

    return (
            <div className={styles.container}>
                {/* <Header /> */}
                <h1 className={styles.resttitle}>Where would you like to eat?</h1>
                ...
                {lunchRestaurants.map((restaurant, index) => (
                    ...
                    <button className={styles.finaliselunch} onClick={redirectToDinner}>Save</button>
