...
*GetGEOSVersionMajor = *Geo::OGRc::GetGEOSVersionMajor;
*GetGEOSVersionMinor = *Geo::OGRc::GetGEOSVersionMinor;
*GetGEOSVersionMicro = *Geo::OGRc::GetGEOSVersionMicro;
...
*CreateGeometryFromEsriJson = *Geo::OGRc::CreateGeometryFromEsriJson;
...
*CreateRangeFieldDomain = *Geo::OGRc::CreateRangeFieldDomain;
*CreateGlobFieldDomain = *Geo::OGRc::CreateGlobFieldDomain;
...
*GetAlternativeName = *Geo::OGRc::FieldDefn_GetAlternativeName;
*GetAlternativeNameRef = *Geo::OGRc::FieldDefn_GetAlternativeNameRef;
*SetAlternativeName = *Geo::OGRc::FieldDefn_SetAlternativeName;
...
*IsUnique = *Geo::OGRc::FieldDefn_IsUnique;
*SetUnique = *Geo::OGRc::FieldDefn_SetUnique;
...
*GetDomainName = *Geo::OGRc::FieldDefn_GetDomainName;
*SetDomainName = *Geo::OGRc::FieldDefn_SetDomainName;
sub DISOWN {
    my $self = shift;
    my $ptr = tied(%$self);
    delete $OWNER{$ptr};
...
*MakeValid = *Geo::OGRc::Geometry_MakeValid;
*Normalize = *Geo::OGRc::Geometry_Normalize;
*RemoveLowerDimensionSubGeoms = *Geo::OGRc::Geometry_RemoveLowerDimensionSubGeoms;
...
*CreatePreparedGeometry = *Geo::OGRc::Geometry_CreatePreparedGeometry;
...
############# Class : Geo::OGR::PreparedGeometry ##############

package Geo::OGR::PreparedGeometry;
use vars qw(@ISA %OWNER %ITERATORS %BLESSEDMEMBERS);
@ISA = qw( Geo::OGR );
%OWNER = ();
%ITERATORS = ();
sub DESTROY {
    ...
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        Geo::OGRc::delete_PreparedGeometry($self);
        delete $OWNER{$self};
    }
}

*Intersects = *Geo::OGRc::PreparedGeometry_Intersects;
*Contains = *Geo::OGRc::PreparedGeometry_Contains;
sub DISOWN {
    my $self = shift;
    my $ptr = tied(%$self);
    delete $OWNER{$ptr};
...
############# Class : Geo::OGR::GeomTransformer ##############

package Geo::OGR::GeomTransformer;
use vars qw(@ISA %OWNER %ITERATORS %BLESSEDMEMBERS);
@ISA = qw( Geo::OGR );
%OWNER = ();
%ITERATORS = ();
sub new {
    my $pkg = shift;
    my $self = Geo::OGRc::new_GeomTransformer(@_);
    bless $self, $pkg if defined($self);
}
...
sub DESTROY {
    ...
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        Geo::OGRc::delete_GeomTransformer($self);
        delete $OWNER{$self};
    }
}

*Transform = *Geo::OGRc::GeomTransformer_Transform;
sub DISOWN {
    my $self = shift;
    my $ptr = tied(%$self);
    delete $OWNER{$ptr};
...
############# Class : Geo::OGR::FieldDomain ##############

package Geo::OGR::FieldDomain;
use vars qw(@ISA %OWNER %ITERATORS %BLESSEDMEMBERS);
@ISA = qw( Geo::OGR );
%OWNER = ();
%ITERATORS = ();
sub DESTROY {
    ...
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        Geo::OGRc::delete_FieldDomain($self);
        delete $OWNER{$self};
    }
}

*GetName = *Geo::OGRc::FieldDomain_GetName;
*GetDescription = *Geo::OGRc::FieldDomain_GetDescription;
*GetFieldType = *Geo::OGRc::FieldDomain_GetFieldType;
*GetFieldSubType = *Geo::OGRc::FieldDomain_GetFieldSubType;
*GetDomainType = *Geo::OGRc::FieldDomain_GetDomainType;
*GetSplitPolicy = *Geo::OGRc::FieldDomain_GetSplitPolicy;
*SetSplitPolicy = *Geo::OGRc::FieldDomain_SetSplitPolicy;
*GetMergePolicy = *Geo::OGRc::FieldDomain_GetMergePolicy;
*SetMergePolicy = *Geo::OGRc::FieldDomain_SetMergePolicy;
*GetMinAsDouble = *Geo::OGRc::FieldDomain_GetMinAsDouble;
*IsMinInclusive = *Geo::OGRc::FieldDomain_IsMinInclusive;
*GetMaxAsDouble = *Geo::OGRc::FieldDomain_GetMaxAsDouble;
*IsMaxInclusive = *Geo::OGRc::FieldDomain_IsMaxInclusive;
*GetGlob = *Geo::OGRc::FieldDomain_GetGlob;
sub DISOWN {
    my $self = shift;
    my $ptr = tied(%$self);
    delete $OWNER{$ptr};
...
*OFSTUUID = *Geo::OGRc::OFSTUUID;
*OJUndefined = *Geo::OGRc::OJUndefined;
*OJLeft = *Geo::OGRc::OJLeft;
*OJRight = *Geo::OGRc::OJRight;
*OFDT_CODED = *Geo::OGRc::OFDT_CODED;
*OFDT_RANGE = *Geo::OGRc::OFDT_RANGE;
*OFDT_GLOB = *Geo::OGRc::OFDT_GLOB;
*OFDSP_DEFAULT_VALUE = *Geo::OGRc::OFDSP_DEFAULT_VALUE;
*OFDSP_DUPLICATE = *Geo::OGRc::OFDSP_DUPLICATE;
*OFDSP_GEOMETRY_RATIO = *Geo::OGRc::OFDSP_GEOMETRY_RATIO;
*OFDMP_DEFAULT_VALUE = *Geo::OGRc::OFDMP_DEFAULT_VALUE;
*OFDMP_SUM = *Geo::OGRc::OFDMP_SUM;
*OFDMP_GEOMETRY_WEIGHTED = *Geo::OGRc::OFDMP_GEOMETRY_WEIGHTED;
...
*ALTER__FLAG = *Geo::OGRc::ALTER__FLAG;
*ALTER_DEFAULT_FLAG = *Geo::OGRc::ALTER_DEFAULT_FLAG;
*ALTER_UNIQUE_FLAG = *Geo::OGRc::ALTER_UNIQUE_FLAG;
*ALTER_DOMAIN_FLAG = *Geo::OGRc::ALTER_DOMAIN_FLAG;
...
*ODsCAddFieldDomain = *Geo::OGRc::ODsCAddFieldDomain;
...
package Geo::OGR;
our $VERSION = '3.0403'; # this needs to be the same as that in gdal_perl.i
