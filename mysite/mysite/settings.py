...
SECRET_KEY = 'django-insecure-o7%wz+uuc&l%yyz^8kkydj044zb#a7zuwik09v+0d5cquo^l9y'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'gmaps/react/build')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'veritast2223@gmail.com'
EMAIL_HOST_PASSWORD = 'zdpsfbhujtdcozjh'
